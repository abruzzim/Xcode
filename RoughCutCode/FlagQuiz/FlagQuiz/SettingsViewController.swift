...
class SettingsViewController: UIViewController {
    @IBOutlet weak var choicesSegmentedControl: UISegmentedControl!
    ...
    override func viewDidLoad() {
        ...
        // select segment based on current number of choices
        choicesSegmentedControl.selectedSegmentIndex =
            model.numberOfGuesses / 2 - 1
        
        // set swithes based on currently selected regions
...
* www.deitel.com/books/iosfp2/. If you have any questions, please email  *
